<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TrangChu.aspx.cs" Inherits="DoHoangHuy._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="jumbotron">
        <h1>WELLCOM TO DISC SHOP </h1>
        <p class="lead bg-danger">Shop Bán Đĩa uy tín và chất lượng .</p>
        <img src="img/5.png" />
        <p><a href="https://shopee.vn/%C4%91%E1%BA%A7u_%C4%91%C4%A9a_dvd-tag" class="btn btn-primary btn-lg">Liên Hệ Thêm &raquo;</a></p>
        <img src="img/2.png" />
    ...
    <div class="row bg-danger">
        <div class="col-md-4 ">
            <h2>Nhạc việt</h2>
            <p>
                Âm nhạc Việt Nam là hệ thống sáng tác âm nhạc của các dân tộc tại Việt Nam và là một phần của lịch sử và văn hóa Việt Nam. Âm nhạc Việt Nam phản ánh những nét đặc trưng của con người, văn hóa, phong tục, địa lý... Việt Nam, trải dài suốt chiều dài lịch sử Việt Nam.
            ...
            <p>
                <a class="btn btn-default" href="https://mp3.zing.vn/">Chi tiết &raquo;</a>
            </p>
        </div>
        <div class="col-md-4 ">
            <h2>Nhạc Hàn</h2>
            ...
            <p>
                <a class="btn btn-default" href="http://duhochanquoc.net.vn/tin-du-hoc/hoc-tieng-han-quoc/nguoi-han-quoc-dung-app-nghe-nhac-gi-367/">Chi tiết &raquo;</a>
            </p>
        </div>
        <div class="col-md-4 ">
            <h2>Nhạc Âu-Mỹ</h2>
            ...
            <p>
                <a class="btn btn-default" href="https://www.nhaccuatui.com/playlist/top-100-pop-usuk-hay-nhat-va.zE23R7bc8e9X.html">Chi tiết &raquo;</a>
            </p>
        </div>
    </div>
